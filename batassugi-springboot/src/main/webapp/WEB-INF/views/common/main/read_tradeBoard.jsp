...
<div class="container main">
	<div class="jumbotron mb-5">
		<h1 class="display-3">TradeBoard</h1>
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="card mb-5 trade-card">
					...
					<c:choose>
						<c:when test="${i==1}"><div class="card-header text-white bg-danger p-2.5"></div></c:when>
					...
					<div class="card-body p-1 pb-2">
						<h6 class="kor m-0"><i class="fa fa-comment-o m-1"></i>여기는 제목 ${i}</h6>
						<h6 class="kor m-0"><i class="fa fa-user m-1"></i>작성자</h6>
					</div> <!-- card-body -->
					<div class="card-footer p-0 pb-1">
						<span class="float-left kor m-0"><i class="fa fa-eye ml-2 mr-1"></i><span class="lead">1</span></span>
						<span class="float-right kor m-0"><i class="fa fa-calendar-check-o mr-1"></i><span class="lead mr-2">18.06.07</span></span>
					</div> <!-- card-footer -->
				</div> <!-- card mb-3 -->
			</div> <!-- col-sm-3 -->
			</c:forEach>
